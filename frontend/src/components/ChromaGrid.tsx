    ...
    >
      ...
      <div
        ...
        style={{
          ...
          maskImage:
            'radial-gradient(circle var(--r) at var(--x) var(--y),transparent 0%,transparent 15%,rgba(0,0,0,0.05) 30%,rgba(0,0,0,0.15)45%,rgba(0,0,0,0.25)60%,rgba(0,0,0,0.40)75%,rgba(0,0,0,0.55)88%,white 100%)',
          WebkitMaskImage:
            'radial-gradient(circle var(--r) at var(--x) var(--y),transparent 0%,transparent 15%,rgba(0,0,0,0.05) 30%,rgba(0,0,0,0.15)45%,rgba(0,0,0,0.25)60%,rgba(0,0,0,0.40)75%,rgba(0,0,0,0.55)88%,white 100%)'
        }}
      />
